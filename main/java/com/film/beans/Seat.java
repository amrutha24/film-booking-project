...
public class Seat
{
	...
	public Seat(long sId, List<String> seatNo, List<Double> price, double total, com.film.beans.Customer customer,
			com.film.beans.CurrentDateOperation operation) {
		super();
		this.sId = sId;
		this.seatNo = seatNo;
		this.price = price;
	...
	public Seat(List<String> seatNo, List<Double> price, double total, com.film.beans.Customer customer,
			com.film.beans.CurrentDateOperation operation) {
		super();
		this.seatNo = seatNo;
		this.price = price;
